...
namespace Salmpled.Migrations
{
    ...
    [Migration("20211126071858_Username")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Salmpled.Models.SamplePlaylistGenre", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Salmpled.Models.SamplePlaylistSamplePlaylistGenre", b =>
                {
                    b.Property<Guid>("SamplePlaylistId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("SamplePlaylistGenreId")
                        .HasColumnType("uuid");

                    b.HasKey("SamplePlaylistId", "SamplePlaylistGenreId");

                    b.HasIndex("SamplePlaylistGenreId");

                    b.ToTable("SamplePlaylistSamplePlaylistGenre");
                });
            ...
            modelBuilder.Entity("Salmpled.Models.SamplePlaylistSamplePlaylistGenre", b =>
                {
                    b.HasOne("Salmpled.Models.SamplePlaylistGenre", "SamplePlaylistGenre")
                        .WithMany("SamplePlaylistSamplePlaylistGenres")
                        .HasForeignKey("SamplePlaylistGenreId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
